...
subtitle: "Trimester 1: Without vs After"
...
comparison <- c(1, 4) # 1 = after, 2 = before, 3 = uninfected, 4 = without 
```
...
# CellChat: Without vs After
CellChat differential analysis compared <font color=#337AB7>**trimester 1**</font> HBV-infected subjects without a flare and HBV-infected subjects that experienced a flare after birth.

## Interaction Counts and Weights {.tabset .tabset-fade}
Plots in this section will have the term differential indicating a subtraction between groups. The color <span style="color: red;">red</span> in the plots indicates <span style="color: red;">increased</span> signaling in the <span style="color: red;">without</span> group compared to the after group and the color <span style="color: blue;">blue</span> indicates <span style="color: blue;">decreased</span> signaling in the <span style="color: blue;">without</span> group compared to the after group.
...
The *Full Comparison tab* shows outgoing and incoming interaction strength comparison for <font color=#337AB7>**trimester 1**</font> after (left) and without (right) flare groupings for each cell type.

The cell type specific tabs show the differential signaling changes between after and without.  The plot is shown as a coordinate plane with 4 quadrants as shown in the image below.  Points in quadrant 1 will indicate increased incoming and outgoing signaling strength in the without group. Points in quadrant 3 will indicate increased incoming and outgoing signaling strength in the after group.  
...
For example if you look at the FCRL1+ B cells plot at the top of the plot in quadrant 1 will be a blue triangle labeled ADGRE5.  The location of ADGRE5 in quadrant 1 of the coordinate plane of the plot indicates that incoming and outgoing signaling strength is higher in the without group.  The triangle indicates outgoing specific and the color indicates without specific.  This means that the outgoing signal was seen only in the without group.  This also means the incoming signal was seen in both the without and before groups.  Points other than black circles indicate that a signal was not present/detected in both groups.
