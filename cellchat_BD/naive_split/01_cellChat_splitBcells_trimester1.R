workdir <- "/data/NHLBI_IDSS/rawdata/NIDDK-15_temp/cellchat_BD/naive_split/trimester1"
...
# rename B-cells
b_cells <- read.csv("/data/NHLBI_IDSS/rawdata/NIDDK-15_temp/count/merge_processing/seurat_merge/B_cells/Bcells_1Tri_FCRL1_Naive_metadata.csv", row.names = 1)
