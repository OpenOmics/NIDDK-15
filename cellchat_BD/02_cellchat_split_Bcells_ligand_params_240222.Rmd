...
## Significant Ligand-Receptor Pair Interactions
...
### FCRL1+ B Cells {.tabset .tabset-fade}
...
The significant interactions for all cell groups with Mono and CD4 T as a source and CD4 T and NK as targets are plotted.

```{r, results='asis'}
netVisual_bubble(cellchat, sources.use=c('Mono', 'CD4 T'), targets.use=c('CD4 T', 'NK'), comparison=c(1,2,3, 4))
```
